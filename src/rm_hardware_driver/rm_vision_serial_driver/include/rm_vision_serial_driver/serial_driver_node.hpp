...
// #include "rm_vision_serial_driver/fixed_packet_tool.hpp"
// #include "rm_vision_serial_driver/protocol.hpp"
// #include "rm_vision_serial_driver/protocol_factory.hpp"
// #include "rm_vision_serial_driver/transporter_interface.hpp"
...
private:
  ...
  std::unique_ptr<tf2_ros::TransformBroadcaster> tf_broadcaster_;
  rclcpp::Publisher<rm_decision_interfaces::msg::RobotStatus>::SharedPtr hp_publisher_;
  rclcpp::Publisher<rm_decision_interfaces::msg::GameStatus>::SharedPtr game_status_publisher_;
};

}  // namespace fyt::serial_driver

#endif  // SERIAL_DRIVER_SERIAL_DRI